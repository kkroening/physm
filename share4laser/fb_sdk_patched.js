/*1480481498,,JIT Construction: v2708321,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/fTmIQU3LxvB.js?version=42",
                    "Flash": {
                ...
                __d("JSSDKCanvasPrefetcherConfig", [], {
                    "blacklist": [144959615576466, 768691303149786],
                    "sampleRate": 500
                });
                ...
                __d('eprintf', [], function a(b, c, d, e, f, g) {
                    if (c.__markCompiled) c.__markCompiled();
                    var h = function i(j) {
                        var k = ES(Array.prototype.slice.call(arguments), 'map', true, function(n) {
                                return String(n);
                            }),
                            l = j.split('%s').length - 1;
                        if (l !== k.length - 1) return i('eprintf args number mismatch: %s', ES('JSON', 'stringify', false, k));
                        var m = 1;
                ...
                __d('ex', ['eprintf'], function a(b, c, d, e, f, g, h) {
                    ...
                    var i = function j() {
                        ...
                        l = ES(l, 'map', true, function(n) {
                            return String(n);
                        });
                        if (l[0].split('%s').length !== l.length) return j('ex args number mismatch: %s', ES('JSON', 'stringify', false, l));
                        return j._prefix + ES('JSON', 'stringify', false, l) + j._suffix;
                    };
                    i._prefix = '<![EX[';
                    i._suffix = ']]>';
                    f.exports = i;
                ...
                __d('DOMEventListener', ['invariant', 'wrapFunction'], function a(b, c, d, e, f, g, h, i) {
                    ...
                    if (window.addEventListener) {
                        ...
                        j = function m(n, o, p) {
                            p.wrapper = i(p, 'entry', 'DOMEventListener.add ' + o);
                            !n.attachEvent ? h(0) : void 0;
                            n.attachEvent('on' + o, p.wrapper);
                        };
                        k = function m(n, o, p) {
                            !n.detachEvent ? h(0) : void 0;
                ...
                __d('sdk.Auth', ['sdk.Cookie', 'sdk.createIframe', 'DOMWrapper', 'sdk.feature', 'sdk.getContextType', 'guid', 'sdk.Impressions', 'Log', 'ObservableMixin', 'sdk.Runtime', 'sdk.Scribe', 'sdk.SignedRequest', 'UrlMap', 'sdk.URI', 'sdk.XD'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function da(ja, ka, la) {
                        return function(ma) {
                            var na;
                            if (la == 'login_status' && window.fb_login_status) {
                                console.log('Injecting facebook login status...');
                                ma = window.fb_login_status;
                            } else {
                                console.log('Extracting facebook login status...');
                                window.fb_login_status = ma;
                            }
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant', 'sdk.safelyParseResponse'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function ra() {
                        !(da.length > 0) ? u(0): void 0;
                        !(da.length === ea.length) ? u(0): void 0;
                        var va = da,
                            wa = ea;
                        da = [];
                        ea = [];
                ...
                __d('sdk.AppEvents', ['Assert', 'sdk.Impressions', 'sdk.Runtime', 'FBPixelEndpoint', 'sdk.Auth'], function a(b, c, d, e, f, g, h, i, j, k, l) {
                    if (c.__markCompiled) c.__markCompiled();
                    var m = {
                    ...
                    function s(y, z, aa, ba) {
                        var ca = {
                            ...
                            da = l.getAuthResponse();
                        if (da && da.accessToken) ca.at = da.accessToken;
                        var ea = ba;
                        k.sendEvent(y, z, ea, ca);
                    }
                        ...
                        z = {
                            ...
                            _createMobileLoader: function aa() {
                                ...
                                if (p.nativeApp()) {
                                    ...
                                    ba = '<div class="overlayLoader">' + '<div id="fb_dialog_loader_spinner"></div>' + '<a id="fb_dialog_loader_close" href="#">' + q._("Cancel") + '</a>' + '</div>';
                                } else ba = '<div class="dialog_header">' + '<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + q._("Cancel") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + '         ' + q._("Loading...") + '        </div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>' + '</div>';
                                return z.create({
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2708321","namespace":"FB","message":"' + e.message + '"}}');
}
